...
static WORD s_wLangID = ElVEES_NLS::GetLangID();

CDllRes::CDllRes() :	m_hDll (DllDLL.hModule) , m_wLangID( s_wLangID )
						
{
//	m_hInstOld = AfxGetResourceHandle();
//	AfxSetResourceHandle(DllDLL.hModule);
}
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	{
		TRACE0("DepCfgLite.DLL Initializing!\n");
	...
	{
		TRACE0("DepCfgLite.DLL Terminating!\n");
