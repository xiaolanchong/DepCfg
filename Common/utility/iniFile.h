...
MACRO_EXCEPTION(IniFileException, CommonException);
MACRO_EXCEPTION(IniValueException, IniFileException);
MACRO_EXCEPTION(EmptyValueException, IniValueException)
MACRO_EXCEPTION(InvalidValueException, IniValueException)
...
public:
  ...
  string GetValue( unsigned const keyID, unsigned const valueID) const throw (IniValueException);
  string GetValue(string const keyname, string const valuename) const throw (IniValueException); 
  int    GetValueI(string const keyname, string const valuename) const throw (IniValueException);



  bool   GetValueB(string const keyname, string const valuename) const  throw (IniValueException)
  {
    return bool( GetValueI( keyname, valuename));
  }

//#pragma warning(3 : 4800)
  double   GetValueF(string const keyname, string const valuename) const throw (IniValueException);
